...
WA_SCHEMA_PATH = Path(__file__).parent / "whatsapp_schema.sql"
...
def generate_whatsapp_sqlite(chats_csv: Path, db_path: Path):
    con, cur = create_empty_db_from_schema(WA_SCHEMA_PATH, db_path)
