...
from secure_compression_framework_lib.multi_stream.compress import ZlibCompressionStream, MSCompressor, MSDecompressor, \
...
from secure_compression_framework_lib.partitioner.types.xml_advanced import XMLDataUnit, XmlAdvancedPartitioner


def compress_xml_advanced_by_element(xml_file: Path, access_control_policy: Callable[[XMLDataUnit], Principal]) -> tuple[bytes, list[str]]:
